...
O projeto também aborda um estudo sobre a implementação dos conceitos de orientação a objetos aplicados ao contexto de notebooks, com a criação de classes pensando em facilitar a aplicabilidade e reprodutibilidade do projeto. A ideia é automatizar a geração de gráficos e visualização de informações sobre as avaliações dos filmes, sobre os filmes, e sobre o cineclube em geral.
